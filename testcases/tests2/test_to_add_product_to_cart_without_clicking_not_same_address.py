...
from pages2.page_for_to_verify_cart_without_clicking_same_as_adress import place_order_with_out_click_same_adrress
@pytest.mark.parametrize("firstname,lastname,email,company,password", [
    ("John", "Doe", "john.doe4@test.com", "TestCompany", "Password123"),
    # ("Jane", "Smith", "jane.smith08@test.com", "AnotherCompany", "Password456"),
])
def test_place_order_register(driver, firstname, lastname, email, company, password):
    ...
    page2=place_order_with_out_click_same_adrress(driver)
    ...
    time.sleep(2)
    page2.uncheck_same_as_for_shipping_address()
    page1.add_address(
        fname="John",
        lname="Doe",
    ...
    page2.to_select_the_new_adress()
    time.sleep(2)

    page2.add_address_shipment(
        fname="John",
        lname="Doe",
        email="johndoe@example.com",
        company="TestCompany",
    ...
    page2.to_click_continue_after_entering()
    time.sleep(2)
